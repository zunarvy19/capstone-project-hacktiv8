...
function Programming() {
  ...
  useEffect(() => {
    setIsLoading(true);
    fetch(
      `https://api.nytimes.com/svc/search/v2/articlesearch.json?q=indonesia&page=${currentPage}&api-key=${process.env.REACT_APP_NYT_API_KEY}`
    )
  ...
  return (
    <div className="container mx-auto pb-5">
      <h1 className="text-3xl font-bold my-3 text-center">Indonesia News</h1>
